...
public class Algoritma {
    ...
    //LINIER SEARCH
    public static void searchdataLinier() {
        System.out.println("\n-------------------------------------");
    ...
    //BINARY SEARCH
    public static void searchdataBinary() {
        System.out.println("\n-------------------------------------");
